                ...
                <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
                    <div className="flex-1">
                        ...
                        <div className="mt-8">
                            <form>
                                ...
                                <div className="mt-6">
                                    <div className="flex justify-between mb-2">
                                        ...
                                        <a href="#" className="text-sm text-gray-400 focus:text-blue-500 hover:text-blue-500 hover:underline">¿Has olvidado tu contraseña?</a>
                                    </div>
                            ...
                            <p className="mt-6 text-sm text-center text-gray-400">Aún no tienes una cuenta? <a href="/register" className="text-blue-500 focus:outline-none focus:underline hover:underline">Sign up</a>.</p>
